...
@section('title', 'Data Pengiriman | Brunsia Samudra')
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="{{ route('laporan_pengiriman.pdf') }}" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm">
                            <i class="fas fa-download fa-sm text-white-50"></i> Unduh Laporan Pengiriman
                        </a>
                    </div>

                    <a class="btn btn-primary mb-4" href="{{ route('data_pengiriman.tambah') }}">Tambah Data Pengiriman</a>
